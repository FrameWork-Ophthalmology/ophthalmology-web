...
export class PlanningMedecinComponent implements OnInit {
  ...
  LabelConsultationER = "";
  constructor(private calandTrans: CalanderTransService, public recept_service: ReceptionService,
     private datePipe: DatePipe,   public param_service: ParametrageService, public i18nService: I18nService,
