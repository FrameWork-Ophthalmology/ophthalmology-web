$(function() {
        ...
        $(document).ready(function() {
            // MetisMenu Initialization (Adapt to your sidebar structure)
            $("#menu").metisMenu(); // Replace '#menu' if your sidebar's ID is different

            // Menu Click Handling (Improved -  Handles Submenus)
            $("#menu a").on("click", function(e) {
                ...
                if ($parentLi.hasClass("mm-active")) {
                    ...
                    $parentLi.children("ul").removeClass("mm-show");
            ...
            $('ul#menu a[href="' + url + '"]').addClass('active').parents('li').addClass('in'); // Updated selector
...
$(function() {
    ...
    // Active Menu Item Highlighting (Simplified)
    // var url = window.location.href;
    // $('ul.nav a[href="' + url + '"]').addClass('active').parents('li').addClass('in');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const span = document.getElementById('spanLabel');
    const sideNav = document.getElementById('sidebar-nav');
    const spanLabelMenu = document.getElementById('spanLabelMenu');
    ...
    if (wrapper && sidebar && pageWrapper && span && sideNav && spanLabelMenu && spanLabelDashbord && spanLabelSetting) { //Check for null before adding event listener
        sidebar.addEventListener('mousemove', () => {
            if (wrapper.classList.contains('tt-toggled')) {
                pageWrapper.classList.add('wide-page');
                span.classList.add('showingSpan');
                sideNav.classList.add('WidthSideBar');
                spanLabelMenu.classList.add('showingSpan');
        ...
        sidebar.addEventListener('mouseleave', () => {
            pageWrapper.classList.remove('wide-page');
            span.classList.remove('showingSpan');
            sideNav.classList.remove('WidthSideBar');
            spanLabelMenu.classList.remove('showingSpan');
        ...
        // const timeInput = document.querySelector('p-inputMask input'); // select the input element

        // timeInput.addEventListener('blur', function() { // Add a listener that activates on blur
